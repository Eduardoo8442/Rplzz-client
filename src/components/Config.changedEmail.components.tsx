...
export default function ChangedEmail({ set }: EmbedProfileProps) {
    ...
    <div>
      ...
      <div className="z-50 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-800 p-8 rounded-lg shadow-2xl w-full max-w-sm">
        <div className="text-center mb-4">
          ...
          <h1 className="text-white text-2xl font-semibold">Email alterado com sucesso!</h1>
        </div>

        <p className="text-gray-400 mb-4">
          Seu email foi atualizado com sucesso. Caso precise de mais alguma coisa, estamos aqui para ajudar!
        </p>
